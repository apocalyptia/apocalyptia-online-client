...
// (28:0) <ClickOutside on:clickoutside={hide} exclude={[trigger]}>
function create_default_slot(ctx) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(28:0) <ClickOutside on:clickoutside={hide} exclude={[trigger]}>",
		ctx
	});
...
function create_fragment$2(ctx) {
	...
	let t1;
	let current;
	let if_block = /*$authUserStore*/ ctx[0] && create_if_block(ctx);
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(span, file$2, 8, 2, 187);
			attr_dev(a, "href", "/");
			attr_dev(a, "class", "link-btn title-link svelte-oosnsl");
			add_location(a, file$2, 7, 1, 144);
			attr_dev(div, "class", "title-bar svelte-oosnsl");
			add_location(div, file$2, 6, 0, 119);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, a);
		...
		p: function update(ctx, [dirty]) {
			if (/*$authUserStore*/ ctx[0]) {
				if (if_block) {
					if (dirty & /*$authUserStore*/ 1) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$capture_state = () => ({ UserMenu, authUserStore, $authUserStore });
...
const components = [
	{
		js: () => Promise.all([import('./index.8f95cf35.js'), __inject_styles(["client-0a4ca75d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.145dd243.js'), __inject_styles(["client-0a4ca75d.css","BackButton-06b11a9e.css","GearBlock-06576c24.css","CharacterSheet-43edc17b.css","index-9937a9de.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./_layout.527fa06e.js'), __inject_styles(["client-0a4ca75d.css","_layout-99a2572b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./description.8eb3c88e.js'), __inject_styles(["client-0a4ca75d.css","description-80b51cac.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./properties.b37ff033.js'), __inject_styles(["client-0a4ca75d.css","properties-f632d8ee.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./abilities.fcd0bfba.js'), __inject_styles(["client-0a4ca75d.css","abilities-6086284f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./skills.b7e253f9.js'), __inject_styles(["client-0a4ca75d.css","Slider-d1ce73a6.css","skills-f59c993f.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./traits.52ea9449.js'), __inject_styles(["client-0a4ca75d.css","Slider-d1ce73a6.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./sheet.d66a6aac.js'), __inject_styles(["client-0a4ca75d.css","GearBlock-06576c24.css","CharacterSheet-43edc17b.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./gear.584df1ac.js'), __inject_styles(["client-0a4ca75d.css","GearBlock-06576c24.css","gear-21f8b712.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./load.447fa443.js'), __inject_styles(["client-0a4ca75d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./new.03d7a1d0.js'), __inject_styles(["client-0a4ca75d.css","BackButton-06b11a9e.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.2454780e.js'), __inject_styles(["client-0a4ca75d.css","BackButton-06b11a9e.css","GearBlock-06576c24.css","index-0e9c855d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.f44e1c5f.js'), __inject_styles(["client-0a4ca75d.css","BackButton-06b11a9e.css","GearBlock-06576c24.css","ManSubRule-cda3e237.css","index-50127c32.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./[chapter].9f4b9a89.js'), __inject_styles(["client-0a4ca75d.css","BackButton-06b11a9e.css","GearBlock-06576c24.css","ManSubRule-cda3e237.css","[chapter]-cacaea9d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.0069f053.js'), __inject_styles(["client-0a4ca75d.css","Spinner-56fc02fe.css","index-cceacc8d.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./index.5344a207.js'), __inject_styles(["client-0a4ca75d.css","Spinner-56fc02fe.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./recover.2127ef3d.js'), __inject_styles(["client-0a4ca75d.css","Spinner-56fc02fe.css"])]).then(function(x) { return x[0]; })
	}
];
