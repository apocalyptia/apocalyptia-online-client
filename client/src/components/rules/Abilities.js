...
export const FavoriteWeapon = new Ability(`Favorite Weapon`, `Botch is only a Fail with this one weapon.`, 1, 3, 0, ``, WeaponList)
...
export const WeaponTraining = new Ability(`Weapon Training`, `+1 ATK for a specific weapon.`, 1, 3, 0, ``, WeaponList)
...
export const EfficientWork = new Ability(`Efficient Work`, `[Time / 2] for a Skill (minimum 1 action).`, 1, 6, 0, ``, SkillList)
...
export const Multilingual = new Ability(`Multilingual*`, `Learn a different form of communication.`, 9, 6, 0, ``)  // Make a list or make an input box?
export const Practice = new Ability(`Practice`, `+1 to a Skill (up to the parent Trait).`, 1, 6, 0, ``, SkillList)
...
export const Unorthodox = new Ability(`Unorthodox*`, `Pick a new parent Trait for a Skill.`, 1, 9, 0, ``, [SkillList, TraitList])  // Need to figure this out. Maybe two Options parameters?
...
export const PowerfulStrike = new Ability(`Powerful Strike*`, `+1 DMG for a specific Melee weapon.`, 1, 15, 0, ``, MeleeList)
...
export const VehicleOperation = new Ability(`Vehicle Operation*`, `Proficiently operate a class of vehicle.`, 1, 18, 0, ``) // Need to add VehicleList when it is made
