<script>
	...
	const newCharacter = () => {
		$characterStore = new Character($rulesStore)
...
<div class='cntr-card'>
    <a href='/creator' class='link-btn' on:click={newCharacter}>Build</a>
    <a href='/creator' class='link-btn' on:click={randomCharacter}>Random</a>
</div>
