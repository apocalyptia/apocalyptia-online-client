<script>
	...
	const handleSearch = event => {
		...
		ruleList = SearchEngine(searchTerm, WearablesList.list)
	}
</script>


<svelte:head>
	<title>Apocalyptia Online - Manual - Wearables</title>
</svelte:head>
<ManualHeader chapter={'Wearables'} on:search={e => handleSearch(e)} />
<ManualBody {ruleList} />
