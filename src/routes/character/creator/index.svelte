<script>
	...
	import abilities from 'routes/character/creator/abilities.svelte'
	import description from 'routes/character/creator/description.svelte'
	import finalize from 'routes/character/creator/finalize.svelte'
	import gear from 'routes/character/creator/gear.svelte'
	import properties from 'routes/character/creator/properties.svelte'
	import skills from 'routes/character/creator/skills.svelte'
	import traits from 'routes/character/creator/traits.svelte'
