class RangedWeapon {
    constructor(type, dmg, hands, rng, cal, mag, reg, notes, sz) {
        this.type = type
        this.dmg = dmg
        this.hands = hands
        this.rng = rng
...
export const RangedList = [
    ...
    new RangedWeapon('Sawn-off Double-Barrel Shotgun',  4, 1, 10,   2,  '12g',      'C', ['Rapid', 'Scatter'],  3),
    new RangedWeapon('Sawn-off Pump Shotgun',           4, 2, 10,   3,  '12g',      'C', ['Scatter'],           3),
