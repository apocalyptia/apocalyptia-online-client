export default (character) => {
	...
	document.documentElement.style.setProperty(`--pri-color`, `rgba(${pR},${pG},${pB},1)`)
	document.documentElement.style.setProperty(`--pri-color-trans`, `rgba(${pR},${pG},${pB},.25)`)
	document.documentElement.style.setProperty(`--sec-color`, `rgba(${sR},${sG},${sB},1)`)
	document.documentElement.style.setProperty(`--sec-color-trans`, `rgba(${sR},${sG},${sB},.25)`)
}