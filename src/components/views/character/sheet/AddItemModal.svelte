<script>
	...
	import MeleeList from 'src/components/rules/gear/weapons/melee/MeleeWeaponList'
	import RangedList from 'src/components/rules/gear/weapons/ranged/RangedWeaponList'
