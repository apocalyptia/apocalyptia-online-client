<div class="modifiers-rules">
    ...
    <div id="ModRefSec" class="Sec2">
        ...
        <div id="ArmorModsSec" class="Sec3">
            ...
            <p>MASK: Obscures and protects face, -1 Perception</p>
        ...
        <div id="WeaponModsSec" class="Sec3">
            ...
            <p>CHOP: +1 DMG when hitting a Head, Arm, or Leg.</p>
            <p>LEVER: 2x C for prying open doors, windows, crates, etc.</p>
            <p>LOUD: Deafness within 10yds. Can be heard from 1 mile away.</p>
            <p>PIERCE: AR and DR are halved for this ATK (round down).</p>
        ...
        <div id="AmmoModsSec" class="Sec3">
            ...
            <p>FLARE: 3FDMG/rnd for 3rnds, 100yd light radius</p>
            <p>JHP: +1 DMG</p>
            <p>MATCH: +1 RATK</p>
            <p>RUBBER: Blunt</p>
            <p>SCATTER: -1 DMG and +1 RATK per extended RNG increment</p>
        ...
        <div id="GearModsSec" class="Sec3">
            ...
            <p>GUN CLEANING KIT: +1 RATK for 1 day, takes 1hr/Gun</p>
            <p>HOLOSIGHT: +1 RATK</p>
            <p>LASER: +1 RATK, -6 RATK to Blind for d6rnds</p>
            <p>SCOPE: +3 Aimed RATKs and Perception(See)</p>
        ...
        <div id="ManeuverModsSec" class="Sec3">
            ...
            <p>CALLED SHOT (LIMBS): -1 RATK or -0 MATK</p>
            <p>CALLED SHOT (DISARM): MATK vs C/2 (if 1h) or C (if 2h)</p>
            <p>DUAL-WIELD: -1 (Primary), -3 (Off-hand)</p>
            <p>FULL DEFENSE: No ATK. DEF bonus = Reflex.</p>
        ...
        <div id="SituationModsSec" class="Sec3">
            ...
            <p>FRIENDLY FIRE: -3 RATK, d6 vs Reflex to ally on Fail</p>
            <p>NEEDS: -1 all rolls per unit of time by Need</p>
            <p>PAIN: -1 per DMG (or other source) to all rolls</p>
            <p>PRONE: +1 RATK, use Reflex, +3 Stealth, and Speed 1yd</p>
            <p>RANGE (RNG): -1 per additional weapon RNG increment</p>
            <p>STUNNED: -6 Perception, Reflex only for DEF</p>
        ...
        <div id="WeatherModsSec" class="Sec3">
            ...
            <p>FOG BANK: -6 Visibility(Cloud)</p>
            <p>GALE WINDS: RATK RNG/2</p>
            <p>HAIL/SLEET: -3 Visibility(Rain), -3 Terrain</p>
            <p>HEAT WAVE: -3 Visibility(Sun)</p>
            <p>RAIN STORM: -1 Visibility(Rain), -1 Terrain</p>
            <p>SNOW: -3 Visibility(Cloud), -1/” Terrain</p>
            <p>TORNADO: -3 Visibility(Cloud)</p>
            <p>TOXIC CLOUD: -6 Visibility(Cloud)</p>
        </div>
    </div>
</div>