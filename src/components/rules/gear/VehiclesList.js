...
*/
	...
	// const cEnhancedBrakes = new Gear(`Enhanced Brakes`,`Build 6#. Brake at -20mph/round.`,3);
	...
	// const cHighFlowExhaust = new Gear(`High-Flow Exhaust`,`Build 6#. Accelerate at +20mph/round.`,3);
	...
	// const cNitrousBooster = new Gear(`Nitrous Booster**`,`Build 15#. +20mph Speed and -3 Han for 1 round. 3 uses.`,3);
	// const cParachute = new Gear(`Parachute`,`Build 12#. Stops vehicle in 1 round. 10 rounds to repack.`,6);
	...
	// const cSafetyHarness = new Gear(`Safety Harness**`,`Build 6#. -1 Wreck BDMG for 1 occupant. Takes 3 rounds.`,1);
