...
import BenelliM4 from './BenelliM4'
import BrowningABolt from './BrowningABolt'
import ColtPython from './ColtPython'
import CompoundBow from './CompoundBow'
import Crossbow from './Crossbow'
import Glock17 from './Glock17'
import HenryGoldenBoy from './HenryGoldenBoy'
import HKMP5 from './HKMP5'
import Marlin1894 from './Marlin1894'
import Mossberg500 from './Mossberg500'
import RecurveBow from './RecurveBow'
import Remington700 from './Remington700'
import Remington870 from './Remington870'
import Ruger1022 from './Ruger1022'
import RugerMkIII from './RugerMkIII'
import SavageMkII from './SavageMkII'
import SIGSauerP290 from './SIGSauerP290'
import SpringfieldM1A from './SpringfieldM1A'
import StoegerCoachgun from './StoegerCoachgun'
import SWBodyguard from './SWBodyguard'
