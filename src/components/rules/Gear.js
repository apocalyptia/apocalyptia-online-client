...
class Ammo extends Gear {
	constructor(name, description, sz, cal, type) {
		super(name, description, sz)
		this.cal = cal
		this.type = type
	}
...
export const ArrowBroadhead = new Ammo(`Broadhead Arrow`, `+1 DMG. Pierce.`, .1, `Arrow`, `Broadhead`)
export const ArrowStandard = new Ammo(`Target Arrow`, `Basic ammo.`, .1, `Arrow`, `Standard`)
export const Standard22 = new Ammo(`.22 Standard`, `Basic ammo.`, .005, `.22`, `Standard`)
export const HollowPoint22 = new Ammo(`.22 Hollow Point`, `+1 DMG.`, .005, `.22`, `Hollow Point`)
export const Match22 = new Ammo(`.22 Match`, `+1 RATK.`, .005, `.22`, `Match`)
export const Standard9mm = new Ammo(`9mm Standard`, `Basic ammo.`, .01, `9mm`, `Standard`)
export const HollowPoint9mm = new Ammo(`9mm Hollow Point`, `+1 DMG.`, .01, `9mm`, `Hollow Point`)
export const Match9mm = new Ammo(`9mm Match`, `+1 RATK.`, .01, `9mm`, `Match`)
export const Standard357 = new Ammo(`.357 Standard`, `Basic ammo.`, .01, `.357`, `Standard`)
export const HollowPoint357 = new Ammo(`.357 Hollow Point`, `+1 DMG.`, .01, `.357`, `Hollow Point`)
export const ArmorPiercing556 = new Ammo(`5.56mm Armor Piercing`, `Pierce.`, .02, `5.56`, `Armor Piercing`)
export const Standard556 = new Ammo(`5.56mm Standard`, `Basic ammo.`, .02, `5.56`, `Standard`)
export const HollowPoint556 = new Ammo(`5.56mm Hollow Point`, `+1 DMG.`, .02, `5.56`, `Hollow Point`)
export const Match556 = new Ammo(`5.56mm Match`, `+1 RATK.`, .02, `5.56`, `Match`)
export const ArmorPiercing308 = new Ammo(`.308 Armor Piercing`, `Pierce.`, .02, `.308`, `Armor Piercing`)
export const Standard308 = new Ammo(`.308 Standard`, `Basic ammo.`, .02, `.308`, `Standard`)
export const HollowPoint308 = new Ammo(`.308 Hollow Point`, `+1 DMG.`, .02, `.308`, `Hollow Point`)
export const Match308 = new Ammo(`.308 Match`, `+1 RATK.`, .02, `.308`, `Match`)
export const Buckshot12g = new Ammo(`12g Buckshot`, `Scatter.`, .05, `12g`, `Buckshot`)
export const Slug12g = new Ammo(`12g Slug`, `RNG x2.`, .05, `12g`, `Slug`)
