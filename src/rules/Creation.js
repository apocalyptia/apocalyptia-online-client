...
const Creation = {
	...
	skills: {
		...
		skillFlow: [`Once per month (in-game), transfer 1 point from a Skill you have not used to one that you have used.`],
		specialties: [
	...
	properties: {
		name: `Properties`,
		desc: [`Properties represent a variety of attributes that are derived from a Character's Trait scores.`],
		step: 2
	},
	abilities: {
		name: `Abilities`,
		desc: [`Abilities are special bonuses, knowledge, or techniques that can be purchased with Experience.`],
		step: 3
	},
	gear: {
		name: `Gear`,
