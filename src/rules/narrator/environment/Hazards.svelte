...
<div id='HazardsSec' class='Sec2'>
	...
	<div id='StarvationHazardSec' class='Sec3'>
		<p>Diabetes halves this lethal time.</p>
	</div>

	<button id='AsphyxiationHazardBtn' class='Btn'>Asphyxiation</button>
	<div id='AsphyxiationHazardSec' class='Sec3'>
		<p>Asthma causes Asphyxiation for d6mins when you Botch Athletics. Wildfire Suffocates for d6hrs. Teargas Suffocates for d6mins. Chlorine gas Suffocates twice as fast for d6+3 minutes.</p>
	</div>
</div>